...
## 9. ОПЫТ РАБОТЫ: ЧТО МОЖНО ЗАЯВИТЬ (по итогам проверки компаний)

Источник: research/08-past-employers.md. Ограничение метода: прямой доступ к сайтам
в этой сессии заблокирован, факты собраны по поисковым сниппетам.

### empresex.io — самый недооценённый пункт твоего профиля

Найдено: это не агентство, а **действующая лицензированная криптобиржа (EU VASP)
с реальными транзакциями**.

Сейчас в профиле стоит `Web & Brand Designer` — формулировка, из которой невозможно
понять, что ты проектировала интерфейс регулируемого финансового продукта с живыми
деньгами. Это прямое подтверждение слова «fintech» в твоём заголовке, и оно у тебя
уже есть — просто не сформулировано.

**МОЖНО ЗАЯВИТЬ:** тип продукта (лицензированная криптобиржа, EU VASP), отрасль,
характер задач (интерфейсы с реальными транзакциями, регуляторные требования),
свой конкретный вклад.

**НЕЛЬЗЯ ЗАЯВЛЯТЬ:** бренд как знак качества. Репутация на Trustpilot смешанная —
есть и похвалы за скорость вывода средств, и обвинения в мошенничестве. Ссылаться
на «надёжный известный продукт» нельзя. Работает здесь **тип продукта, а не имя**.

### for.co (FOR®)

Найдено: реальное remote-first агентство (Хельсинки, Нью-Йорк, Майами, Дубай, Киев,
Лагос), брендинг и продуктовый дизайн для tech/B2B/стартапов.

**МОЖНО ЗАЯВИТЬ:** тип клиентов (tech, B2B, стартапы), международный распределённый
формат работы, характер задач.

**НЕЛЬЗЯ ЗАЯВЛЯТЬ:** имя как доказательство. Компания малоузнаваема — нет профилей
на Crunchbase, LinkedIn, Clutch. Название читателю ничего не скажет, работать будет
только описание задач. Единственный найденный именной клиент — Clever Studios
(CLEVER GROUP GmbH, Германия) — упоминать можно, ТОЛЬКО если это твой личный проект.

### Real Media

Найдено: наиболее вероятный кандидат — realmedia.ink. Его описание почти дословно
совпадает с твоим овервью (EU & MENA founders, Sprint/Marathon, fintech/AI SaaS/
cybersecurity/iGaming). Совпадение сильное, но стопроцентно не подтверждено.
Блок «Sprint vs Marathon» подтверждён на уровне поисковой индексации.

**ДЕЙСТВИЕ:** проверь ссылку сама и поставь её в кейс прямой — это ровно то,
что требуют дорогие заказчики.

### Чего нет ни по одной компании

Год основания, размер команды, объём инвестиций — данных нет. В профиль такие цифры
не ставим: непроверяемое утверждение отсеивает так же, как отсутствие портфолио.

### Как переписать сами должности

Абстрактный титул `Design Lead (Web & UI/UX)` не говорит ни о чём. Заменить на
конкретные глаголы действия с указанием границ ответственности:

```
Design Lead — вела продукт от вайрфрейма до Next.js-хендоффа: IA, UI,
дизайн-система, настройка CMS, запуск.
```

Формулировка должна отвечать на вопрос заказчика «что именно делала ты»,
а не «как называлась твоя должность».
